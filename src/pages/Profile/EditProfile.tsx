                ...
                >
                    ...
                    {ok && (
                        <div className="p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 animate-fade-in">
                            <div className="flex gap-3">
                                ...
                                <p className="text-sm text-green-600 dark:text-green-400 leading-relaxed">{ok}</p>
                            </div>
                        </div>
                    )}
                            ...
                            <div className="relative">
                                {photoPreview ? (
                                    <img
                                        src={photoPreview}
                                        alt="Profile"
                                        className="w-24 h-24 sm:w-28 sm:h-28 rounded-full object-cover border-4 border-[var(--color-border)] shadow-lg"
                                    />
                                ) : (
                                    <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-[var(--color-brand-500)] to-[var(--color-brand-600)] flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                                        {first?.[0]?.toUpperCase() || "U"}
                                    </div>
                                )}
                                <label
                                    htmlFor="photo-upload"
                                    className="absolute bottom-0 right-0 p-2.5 rounded-full bg-[var(--color-brand-500)] text-white hover:bg-[var(--color-brand-600)] cursor-pointer shadow-lg transition-all hover:scale-110 active:scale-95"
                                >
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--color-surface-elevated)] border border-[var(--color-border)] hover:border-[var(--color-brand-500)] transition-colors">
                            <div className="flex items-center gap-3">
                                <div className="p-2 rounded-lg bg-[var(--color-brand-50)] dark:bg-[var(--color-brand-900)]/30">
                                    <svg className="w-5 h-5 text-[var(--color-brand-600)] dark:text-[var(--color-brand-400)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
